...
def reading_faces_and_displaying():
    face_array = []
    displaying_faces = []
    for face_images in glob.glob('C:/Users/suagrawa/Desktop/Spring_2019_IIIT/Monsoon 2019/SMAI Assignments/Assignment2/dataset/IMFDB/*.png'): # assuming jpg
...
train_list=[]
for images in glob.glob('C:/Users/suagrawa/Desktop/Spring_2019_IIIT/Monsoon 2019/SMAI Assignments/Assignment2/dataset/IMFDB/*.png'):
    a1=images
    _,a1 = a1.split('\\')
    #a1,_=a1.split('')
