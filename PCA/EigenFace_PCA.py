...
def reading_faces_and_displaying():
    face_array = []
    displaying_faces = []
    for face_images in glob.glob('C:/Users/suagrawa/Optimization-Python/Data/Eigenfaces/Train/*.jpg'): # assuming jpg
...
def reading_test_images():
    test_images=[]
    for images in glob.glob('C:/Users/suagrawa/Optimization-Python/Data/Eigenfaces/Test/*.jpg'):  # assuming jpg
...
train_list=[]
for images in glob.glob('C:/Users/suagrawa/Optimization-Python/Data/Eigenfaces/Train/*.jpg'):
    a1=images
    _,a1 = a1.split('\\')
    #a1,_=a1.split('')
...
print(train_list)
test_list=[]
for images in glob.glob('C:/Users/suagrawa/Optimization-Python/Data/Eigenfaces/Test/*.jpg'):
    a1=images
    _,a1 = a1.split('\\')
    a1,_=a1.split('_', maxsplit=1)
    test_list.append(a1)
